...
if (!class_exists('TCPDF')) {
	 ...
	 */ 
	define('PDF_PRODUCER', 'TCPDF 4.7.001_PHP4 (http://www.tcpdf.org)');
	...
	*/
	class TCPDF {
		...
		*/
		 ...
		 */
		var $byterange_string = '/ByteRange[0 ********** ********** **********]';
		 ...
		 * @since 4.6.028 (2009-08-25)
		 */
		var $sig_annot_ref = '***SIGANNREF*** 0 R';
		 ...
		 * @since 4.7.000 (2009-08-29)
		 */
		var $embedded_start_obj_id = 100000;
		 ...
		 * @since 4.7.000 (2009-08-29)
		 */
		var $annots_start_obj_id = 200000;
		...
		* @since 2.0.000 (2008-01-03)
		 */
		function setRTL($enable, $resetx=true) {
		...
		*/
		...
		/**
	 	 ...
	 	 * @since 4.6.021 (2009-07-20)
		 */
		function setContentMark($page=0) {
			if ($page <= 0) {
				$page = $this->page;
			}
		...
		*/
		function Arrow($x0, $y0, $x1, $y1, $head_style=0, $arm_size=5, $arm_angle=15) {
