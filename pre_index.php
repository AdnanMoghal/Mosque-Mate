...
if ( strstr ($site_base, 'mycpanel') ){
	$webroot = rtrim ($site_base, 'mycpanel');
	$adminroot = $site_base.'/';
}
else{
	if ($site_base != '/'){
		$webroot = $site_base.'/';
	 	$adminroot = $site_base.'/target/';
	}
	else{
		$webroot = $site_base;
	 	$adminroot = $site_base.'mycpanel/';
	}
}
//echo $adminroot;
//echo $webroot;
...
setConfigValue ('module', getPath('lmsmodule'));
