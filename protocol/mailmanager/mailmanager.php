...
class mailmanager{	
	...
	function sendMailViaSendMail ($from, $from_name, $to, $subject, $body, $attachmen=array() ){
		...
		$body             = $body;
		//$body             = preg_replace("[\]",'',$body);//eregi_replace
	...
	function sendMailViaSmtp ($from, $from_name, $to, $subject, $body, $attachment=array(), $host, $port='25', $smtp_secure=false, $smtp_auth=false, $smtp_user='test@webnit24.com', $smtp_pass='[12345p]'  ){
