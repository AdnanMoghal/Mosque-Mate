...
class filemanager
{
    ...
    //
    function imageResizeSave ($input_file_path = "", $new_width = 0, $new_height = 0, $save_path = "./",$arr1=array(),$desired = 1, $quality = 100, $imagelib='gd') 
    { 
        ...
        if ($imagelib == 'gd'){
            ...
            $imagedata = $arr1;//getimagesize($input_file_path); 
    ...
    // Third parameter is optional file rename.
    //
